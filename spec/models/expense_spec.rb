...
RSpec.describe Expense, type: :model do
  ...
  describe 'validations' do
    subject { described_class.new(name: 'Groceries', amount: 50.0, user: User.create(name: 'Ye Min', email: 'yemin@gmail.com', password: 'password123'), category: Category.create(name: 'Food')) }
