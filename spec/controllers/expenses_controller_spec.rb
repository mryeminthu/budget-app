...
RSpec.describe ExpensesController, type: :controller do
  let(:user) { User.find_or_create_by(email: 'test@example.com') { |u| u.password = 'password'; u.name = 'Test User' } }
  let(:valid_icon) { fixture_file_upload(Rails.root.join('app', 'assets', 'images', 'arrow-left.svg'), 'image/svg+xml') }
